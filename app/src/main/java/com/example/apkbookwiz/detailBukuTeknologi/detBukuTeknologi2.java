...
public class detBukuTeknologi2 extends AppCompatActivity {
    ImageView back_teknologi, btn_read, btn_wistlist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_det_buku_teknologi2);
        ...
        back_teknologi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(detBukuTeknologi2.this, teknologiPage.class);
        ...
        btn_read.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(detBukuTeknologi2.this, bukuteknologi2.class);
                startActivity(intent);
            }
        });
        ...
        btn_wistlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(detBukuTeknologi2.this, wishlistPage.class);
                startActivity(intent);
            }
        });
    }
