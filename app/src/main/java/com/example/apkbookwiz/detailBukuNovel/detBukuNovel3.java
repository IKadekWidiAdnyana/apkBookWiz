...
public class detBukuNovel3 extends AppCompatActivity {
    ImageView back_novel, btn_read, btn_wistlist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_det_buku_novel3);
        ...
        back_novel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(detBukuNovel3.this, novelPage.class);
        ...
        btn_read.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(detBukuNovel3.this, bukunovel3.class);
                startActivity(intent);
            }
        });
        ...
        btn_wistlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(detBukuNovel3.this, wishlistPage.class);
                startActivity(intent);
            }
        });
    }
