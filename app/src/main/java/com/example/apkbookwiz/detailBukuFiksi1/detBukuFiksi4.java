...
public class detBukuFiksi4 extends AppCompatActivity {
    ImageView back_fiksi, btn_read, btn_wistlist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_det_buku_fiksi4);
        ...
        back_fiksi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(detBukuFiksi4.this, fiksiPage.class);
        ...
        btn_read.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(detBukuFiksi4.this, bukufiksi4.class);
                startActivity(intent);
            }
        });
        ...
        btn_wistlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(detBukuFiksi4.this, wishlistPage.class);
                startActivity(intent);
            }
        });
    }
