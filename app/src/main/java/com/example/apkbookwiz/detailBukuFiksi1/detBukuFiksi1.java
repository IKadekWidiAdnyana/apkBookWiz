    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_fiksi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(detBukuFiksi1.this, fiksiPage.class);
        ...
        btn_read.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(detBukuFiksi1.this, bukufiksi1.class);
                startActivity(intent);
            }
        });
        ...
        btn_wistlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(detBukuFiksi1.this, wishlistPage.class);
                startActivity(intent);
            }
        });
    }
